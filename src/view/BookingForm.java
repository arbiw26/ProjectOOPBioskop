...
public class BookingForm extends javax.swing.JFrame {
    ...
    private void updateSummary() {
        ...
        jLabelMovie.setText(movie == null ? "-" : movie.getTitle() + " (" + movie.getRating() + ")" + " | " + movie.getGenre() + " | " + movie.getDuration() + " Minutes");
        ...
        jLabelTotal.setText(customer == null ? "-" : "Rp " + String.format("%,.0f", total) + " (" + customer.getMembership() + ")");
    }
    /**
                        ...
                        .addGroup(jPanelSummaryLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanelSummaryLayout.createSequentialGroup()
                                ...
                                .addGroup(jPanelSummaryLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jLabelStudio, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
                    .addGroup(jPanelSummaryLayout.createSequentialGroup()
